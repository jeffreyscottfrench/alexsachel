...
if ($secretinfo == "")
{
  ...
  $emess.= "<tr>\r\n<td style='padding-top: 15px; padding-bottom: 5px; max-width: 200px; color:#888888'>Gender:</td>\r\n<td style='padding-top: 15px; padding-bottom: 5px;'>".$gender."</td></tr>\r\n";
  $emess.= "<tr>\r\n<td style='padding-top: 15px; padding-bottom: 5px; max-width: 200px; color:#888888'>Sizing:</td>\r\n<td style='padding-top: 15px; padding-bottom: 5px;'>".$sizing."</td></tr>\r\n";
  ...
  $emess.= "<tr>\r\n<td colspan='2' style='padding-top: 45px; padding-bottom: 5px; color:#888888'>When would you like to start, or what date do you need to be ready by?</td></tr>\r\n";
  $emess.= "<tr>\r\n<td colspan='2' style=' border-top: 1px solid #dddddd; border-bottom: 1px solid #dddddd;padding-top: 10px; padding-bottom: 60px;'>".$timeline."</td></tr>\r\n";
  ...
  $emess.= "<tr>\r\n<td colspan='2' style='padding-top: 45px; padding-bottom: 5px; color:#888888'>Your overall target budget (service + clothing combined)</td></tr>\r\n";
  $emess.= "<tr>\r\n<td colspan='2' style=' border-top: 1px solid #dddddd; border-bottom: 1px solid #dddddd;padding-top: 10px; padding-bottom: 60px;'>".$budget."</td></tr>\r\n";
  ...
  $eAltMess.= "Gender: ".$gender."\r\n";
  $eAltMess.= "Sizing: ".$sizing."\r\n";
